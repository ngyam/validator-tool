...
exports.handler = function (argv) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield changePayoutAddress(argv);
    });
};
function changePayoutAddress(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let result;
        try {
            result = yield contract.methods.setPayoutAddress(web3.utils.toChecksumAddress(argv.payoutaddress)).send({
                from: validator,
...
exports.changePayoutAddress = changePayoutAddress;
//# sourceMappingURL=changeTo.js.map